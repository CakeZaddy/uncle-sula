      ...
      <div class='grid grid-cols-1 md:grid-cols-2 justify-items-center gap-5 mb-5 mx-[5%] lg:gap-10 lg:mx-[13%] '>
        ...
        <a href='https://cakezaddy.github.io/Image-Rotator/'>
          <div class='w-[350] lg:w-[450px] relative rounded-xl drop-shadow-[0px_5px_5px_rgba(0,0,0,0.50)] hover:drop-shadow-[0_10px_10px_rgba(0,0,0,0.50)] '>
            ...
            <div class='absolute bottom-0 bg-gray-600/80 w-full h-[20%] rounded-b-xl '>
              <div class='flex items-center absolute bottom-2 left-2'>
                <p class='font-semibold text-lg'>Photo Slider Page</p>
                <FiLink class='font-bold text-green-400 ml-5' />
              </div>
            </div>
          </div>
        ...
        <a href='https://cakezaddy.github.io/Notepad-App/'>
          <div class='w-[350] lg:w-[450px] relative rounded-xl drop-shadow-[0px_5px_5px_rgba(0,0,0,0.50)] hover:drop-shadow-[0_10px_10px_rgba(0,0,0,0.50)] '>
            ...
            <div class='absolute bottom-0 bg-gray-600/80 w-full h-[20%] rounded-b-xl '>
              <div class='flex items-center absolute bottom-2 left-2'>
                <p class='font-semibold text-lg'>NotePad App</p>
                <FiLink class='font-bold text-green-400 ml-5' />
              </div>
            </div>
          </div>
        ...
        <a href='https://cakezaddy.github.io/Digital-Clock/'>
          <div class='w-[350] lg:w-[450px] relative rounded-xl drop-shadow-[0px_5px_5px_rgba(0,0,0,0.50)] hover:drop-shadow-[0_10px_10px_rgba(0,0,0,0.50)] '>
            ...
            <div class='absolute bottom-0 bg-gray-600/80 w-full h-[20%] rounded-b-xl '>
              <div class='flex items-center absolute bottom-2 left-2'>
                <p class='font-semibold text-lg'>Digital Clock Page</p>
                <FiLink class='font-bold text-green-400 ml-5' />
              </div>
            </div>
          </div>
        ...
        <a href='https://cakezaddy.github.io/Dad-Jokes/'>
          <div class='w-[350] lg:w-[450px] relative rounded-xl drop-shadow-[0px_5px_5px_rgba(0,0,0,0.50)] hover:drop-shadow-[0_10px_10px_rgba(0,0,0,0.50)] '>
            ...
            <div class='absolute bottom-0 bg-gray-600/80 w-full h-[20%] rounded-b-xl '>
              <div class='flex items-center absolute bottom-2 left-2'>
                <p class='font-semibold text-lg'>Dad Jokes Generator</p>
                <FiLink class='font-bold text-green-400 ml-5' />
              </div>
            </div>
          </div>
        ...
        <a href='http://cakezaddy.github.io/Double-LandingPage/'>
          <div class='w-[350] lg:w-[450px] relative rounded-xl drop-shadow-[0px_5px_5px_rgba(0,0,0,0.50)] hover:drop-shadow-[0_10px_10px_rgba(0,0,0,0.50)] '>
            <img
              ...
              alt='Double LandingPage'
            />
            <div class='absolute bottom-0 bg-gray-600/80 w-full h-[20%] rounded-b-xl '>
              <div class='flex items-center absolute bottom-2 left-2'>
                <p class='font-semibold text-lg'>Double LandingPage</p>
                <FiLink class='font-bold text-green-400 ml-5' />
              </div>
            </div>
          </div>
